...
export const getServerSideProps: GetServerSideProps = async (context) => {
    return new Promise(async (resolve) => {
        ...
        if (state === 'linkDiscordAccount') {
            return resolve({
                redirect: {
                    destination: `/dashboard/settings/link-discord?code=${encodeURIComponent(code)}`,
                    permanent: false,
                },
            });
        }
        ...
        caller.auth
            .discordLogin({ code, redirect_uri: `${baseUrl}/auth/discord` })
            .then((resp) => {
